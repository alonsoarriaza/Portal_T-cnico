...
* **Estilos & Diseño:** TailwindCSS con paleta corporativa oscura (Slate 950 / Brand Cyan / Emerald)
...
* **PostgreSQL** en ejecución en el puerto `5432` con la base de datos `portal_abaxial` creada:
  ```sql
...
*(Flyway creará automáticamente todas las tablas, roles, permisos y el usuario inicial `admin`)*.
...
*(Se recomienda cambiar la contraseña o configurar variables `INITIAL_ADMIN_PASSWORD` en producción)*.

---

## 7. Despliegue con Docker Compose (Producción o Local)
